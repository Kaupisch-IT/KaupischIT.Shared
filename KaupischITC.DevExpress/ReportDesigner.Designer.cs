namespace KaupischITC.DevExpressControls
{
	partial class ReportDesigner
	{
		...
		private void InitializeComponent()
		{
			...
			((System.ComponentModel.ISupportInitialize)(this.xrDesignBarManager)).BeginInit();
			...
			this.bar2.Text = "Standard Elemente";
			// 
			// xrDesignDockManager
			// 
			this.xrDesignDockManager.AutoHiddenPanelCaptionShowMode = DevExpress.XtraBars.Docking.AutoHiddenPanelCaptionShowMode.ShowForActivePanel;
			this.xrDesignDockManager.Form = this;
			this.xrDesignDockManager.HiddenPanels.AddRange(new DevExpress.XtraBars.Docking.DockPanel[] {
            this.toolBoxDockPanel1,
            this.groupAndSortDockPanel1,
            this.errorListDockPanel1});
			this.xrDesignDockManager.ImageStream = ((DevExpress.Utils.ImageCollectionStreamer)(resources.GetObject("xrDesignDockManager.ImageStream")));
			this.xrDesignDockManager.MenuManager = this.xrDesignBarManager;
			this.xrDesignDockManager.RootPanels.AddRange(new DevExpress.XtraBars.Docking.DockPanel[] {
            this.panelContainer1});
			this.xrDesignDockManager.TopZIndexControls.AddRange(new string[] {
			...
			this.xrDesignDockManager.XRDesignPanel = this.xrDesignPanel;
			// 
			// toolBoxDockPanel1
			// 
			...
			this.toolBoxDockPanel1.Location = new System.Drawing.Point(29, 62);
			...
			this.toolBoxDockPanel1.Size = new System.Drawing.Size(165, 423);
			this.toolBoxDockPanel1.Text = "Werkzeuge";
			...
			this.toolBoxDockPanel1_Container.Size = new System.Drawing.Size(157, 396);
			...
			this.groupAndSortDockPanel1.OriginalSize = new System.Drawing.Size(700, 105);
			...
			this.groupAndSortDockPanel1.Size = new System.Drawing.Size(770, 105);
			this.groupAndSortDockPanel1.Text = "Gruppen und Sortierung";
			...
			this.groupAndSortDockPanel1_Container.Size = new System.Drawing.Size(770, 105);
			...
			this.errorListDockPanel1.Location = new System.Drawing.Point(29, 441);
			this.errorListDockPanel1.Name = "errorListDockPanel1";
			this.errorListDockPanel1.OriginalSize = new System.Drawing.Size(200, 160);
			this.errorListDockPanel1.SavedDock = DevExpress.XtraBars.Docking.DockingStyle.Bottom;
			this.errorListDockPanel1.SavedIndex = 1;
			this.errorListDockPanel1.Size = new System.Drawing.Size(778, 160);
			this.errorListDockPanel1.Text = "Skript Fehler";
			this.errorListDockPanel1.Visibility = DevExpress.XtraBars.Docking.DockVisibility.Hidden;
			this.errorListDockPanel1.XRDesignPanel = this.xrDesignPanel;
			// 
			// errorListDockPanel1_Container
			// 
			this.errorListDockPanel1_Container.Location = new System.Drawing.Point(4, 23);
			this.errorListDockPanel1_Container.Name = "errorListDockPanel1_Container";
			this.errorListDockPanel1_Container.Size = new System.Drawing.Size(770, 133);
			this.errorListDockPanel1_Container.TabIndex = 0;
			// 
			// xrDesignBarManager
			// 
			this.xrDesignBarManager.AllowCustomization = false;
			barInfo1.Bar = this.bar2;
			barInfo1.ToolboxType = DevExpress.XtraReports.UserDesigner.ToolboxType.Standard;
			this.xrDesignBarManager.BarInfos.AddRange(new DevExpress.XtraReports.UserDesigner.BarInfo[] {
            barInfo1});
			this.xrDesignBarManager.Bars.AddRange(new DevExpress.XtraBars.Bar[] {
            this.designBar3,
            this.designBar4,
            this.bar2});
			this.xrDesignBarManager.DockControls.Add(this.barDockControlTop);
			this.xrDesignBarManager.DockControls.Add(this.barDockControlBottom);
			this.xrDesignBarManager.DockControls.Add(this.barDockControlLeft);
			this.xrDesignBarManager.DockControls.Add(this.barDockControlRight);
			this.xrDesignBarManager.DockManager = this.xrDesignDockManager;
			this.xrDesignBarManager.FontNameBox = this.recentlyUsedItemsComboBox1;
			this.xrDesignBarManager.FontNameEdit = this.barEditItem1;
			this.xrDesignBarManager.FontSizeBox = this.designRepositoryItemComboBox1;
			this.xrDesignBarManager.FontSizeEdit = this.barEditItem2;
			this.xrDesignBarManager.Form = this;
			this.xrDesignBarManager.FormattingToolbar = this.designBar3;
			this.xrDesignBarManager.HintStaticItem = this.barStaticItem1;
			this.xrDesignBarManager.ImageStream = ((DevExpress.Utils.ImageCollectionStreamer)(resources.GetObject("xrDesignBarManager.ImageStream")));
			this.xrDesignBarManager.Items.AddRange(new DevExpress.XtraBars.BarItem[] {
            this.barEditItem1,
            this.barEditItem2,
			...
			this.xrDesignBarManager.LayoutToolbar = this.designBar4;
			this.xrDesignBarManager.MaxItemId = 76;
			this.xrDesignBarManager.RepositoryItems.AddRange(new DevExpress.XtraEditors.Repository.RepositoryItem[] {
			...
			this.xrDesignBarManager.ZoomItem = this.xrZoomBarEditItem1;
			// 
			// designBar3
			// 
			this.designBar3.BarName = "Formatting Toolbar";
			this.designBar3.DockCol = 0;
			...
			this.designBar3.Text = "Werkzeugleiste bearbeiten";
			// 
			// barEditItem1
			// 
			...
			// commandBarItem1
			// 
			this.commandBarItem1.Caption = "&Fett";
			...
			// commandBarItem2
			// 
			this.commandBarItem2.Caption = "&Kursiv";
			...
			// commandBarItem3
			// 
			this.commandBarItem3.Caption = "&Unterstrichen";
			...
			this.commandColorBarItem1.Caption = "&Schriftfarbe";
			...
			this.commandColorBarItem2.Caption = "&Hintergrund Farbe";
			...
			// commandBarItem4
			// 
			this.commandBarItem4.Caption = "&Links";
			...
			// commandBarItem5
			// 
			this.commandBarItem5.Caption = "&Zentriert";
			...
			// commandBarItem6
			// 
			this.commandBarItem6.Caption = "&Rechts";
			...
			// commandBarItem7
			// 
			this.commandBarItem7.Caption = "&Blocksatz";
			...
			this.designBar4.DockCol = 1;
			this.designBar4.DockRow = 0;
			...
			this.designBar4.Offset = 494;
			this.designBar4.Text = "Layout der Werkzeugleiste";
			// 
			// commandBarItem8
			// 
			this.commandBarItem8.Caption = "am R&aster ausrichten";
			...
			// commandBarItem9
			// 
			this.commandBarItem9.Caption = "&Links";
			...
			// commandBarItem10
			// 
			this.commandBarItem10.Caption = "&Zentriert";
			...
			// commandBarItem11
			// 
			this.commandBarItem11.Caption = "&Rechts";
			...
			// commandBarItem12
			// 
			this.commandBarItem12.Caption = "&Oben";
			...
			// commandBarItem13
			// 
			this.commandBarItem13.Caption = "&Mittig";
			...
			// commandBarItem14
			// 
			this.commandBarItem14.Caption = "&Unten";
			...
			// commandBarItem15
			// 
			this.commandBarItem15.Caption = "Br&eite";
			...
			// commandBarItem16
			// 
			this.commandBarItem16.Caption = "Am &Raster ausrichten";
			...
			// commandBarItem17
			// 
			this.commandBarItem17.Caption = "&Höhe";
			...
			// commandBarItem18
			// 
			this.commandBarItem18.Caption = "&Beide";
			...
			// commandBarItem19
			// 
			this.commandBarItem19.Caption = "&Angleichen";
			...
			// commandBarItem20
			// 
			this.commandBarItem20.Caption = "&Erhöhen";
			...
			// commandBarItem21
			// 
			this.commandBarItem21.Caption = "&Vermindern";
			...
			// commandBarItem22
			// 
			this.commandBarItem22.Caption = "En&tfernen";
			...
			// commandBarItem23
			// 
			this.commandBarItem23.Caption = "&Angleichen";
			...
			// commandBarItem24
			// 
			this.commandBarItem24.Caption = "&Erhöhen";
			...
			// commandBarItem25
			// 
			this.commandBarItem25.Caption = "&Vermindern";
			...
			// commandBarItem26
			// 
			this.commandBarItem26.Caption = "En&tfernen";
			...
			// commandBarItem27
			// 
			this.commandBarItem27.Caption = "Hor&izontal";
			...
			// commandBarItem28
			// 
			this.commandBarItem28.Caption = "&Vertikal";
			...
			// commandBarItem29
			// 
			this.commandBarItem29.Caption = "Nach &vorne bringen";
			...
			// commandBarItem30
			// 
			this.commandBarItem30.Caption = "Nach &hinten bringen";
			...
			// commandBarItem31
			// 
			this.commandBarItem31.Caption = "&Neu";
			...
			// commandBarItem32
			// 
			this.commandBarItem32.Caption = "&Öffnen";
			...
			// commandBarItem33
			// 
			this.commandBarItem33.Caption = "&Speichern";
			...
			// commandBarItem34
			// 
			this.commandBarItem34.Caption = "&Ausschneiden";
			...
			// commandBarItem35
			// 
			this.commandBarItem35.Caption = "&Kopieren";
			...
			// commandBarItem36
			// 
			this.commandBarItem36.Caption = "&Einfügen";
			...
			// commandBarItem37
			// 
			this.commandBarItem37.Caption = "&Rückgängig";
			...
			// commandBarItem38
			// 
			this.commandBarItem38.Caption = "&Wiederholen";
			...
			// barSubItem1
			// 
			this.barSubItem1.Caption = "&Datei";
			...
			// commandBarItem40
			// 
			this.commandBarItem40.Caption = "Speichern &als...";
			...
			this.commandBarItem40.Hint = "Speichert den Bericht unter einen anderen Namen.";
			this.commandBarItem40.Id = 61;
			this.commandBarItem40.Name = "commandBarItem40";
			// 
			// commandBarItem44
			// 
			this.commandBarItem44.Caption = "A&lle speichern";
			...
			// commandBarItem42
			// 
			this.commandBarItem42.Caption = "&Löschen";
			...
			this.commandBarItem42.Hint = "Das Element löschen.";
			this.commandBarItem42.Id = 63;
			this.commandBarItem42.Name = "commandBarItem42";
			// 
			// commandBarItem43
			// 
			this.commandBarItem43.Caption = "&Alle auswählen";
			...
			this.commandBarItem43.Hint = "Markiert alle Elemente des Dokument.";
			...
			// barSubItem3
			// 
			this.barSubItem3.Caption = "&Ansicht";
			...
			// 
			this.barDockPanelsListItem1.Caption = "&Fenster";
			...
			// barSubItem6
			// 
			this.barSubItem6.Caption = "F&ormat";
			...
			// barSubItem7
			// 
			this.barSubItem7.Caption = "&Schriftart";
			...
			// barSubItem8
			// 
			this.barSubItem8.Caption = "&Ausrichtung";
			...
			// barSubItem9
			// 
			this.barSubItem9.Caption = "&Ausrichtung";
			...
			// barSubItem10
			// 
			this.barSubItem10.Caption = "&Gleiche Größe";
			...
			// barSubItem11
			// 
			this.barSubItem11.Caption = "&Horizontaler Abstand";
			...
			// barSubItem12
			// 
			this.barSubItem12.Caption = "&Vertikaler Abstand";
			...
			// barSubItem13
			// 
			this.barSubItem13.Caption = "Im Fenster &zentrieren";
			...
			// barSubItem14
			// 
			this.barSubItem14.Caption = "&Reihenfolge";
			...
			// barSubItem15
			// 
			this.barSubItem15.Caption = "&Fenster";
			...
			this.commandBarCheckItem1.Hint = "Wechselt zwischen Tabs und Fenster MDI Layout-Modi";
			...
			// commandBarItem45
			// 
			this.commandBarItem45.Caption = "&Kaskade";
    ...
    "ppen";
			...
			// commandBarItem46
			// 
			this.commandBarItem46.Caption = "Platte &Horizontal";
			...
			// commandBarItem47
			// 
			this.commandBarItem47.Caption = "Platte &Vertikal";
			...
			// commandBarItem49
			// 
			this.commandBarItem49.Caption = "Zoom verkleinern ";
			...
			// commandBarItem50
			// 
			this.commandBarItem50.Caption = "Zoom vergrößern";
			...
			this.panelContainer1.ID = new System.Guid("f12a17e6-fbbd-4043-a7c7-a2c1d14d0e06");
			this.panelContainer1.Location = new System.Drawing.Point(908, 29);
			this.panelContainer1.Name = "panelContainer1";
			this.panelContainer1.OriginalSize = new System.Drawing.Size(250, 200);
			this.panelContainer1.Size = new System.Drawing.Size(250, 572);
			...
			this.panelContainer2.ID = new System.Guid("3fc9d927-cee6-46a0-b76f-d63bb4b46399");
			this.panelContainer2.Location = new System.Drawing.Point(0, 0);
			this.panelContainer2.Name = "panelContainer2";
			this.panelContainer2.OriginalSize = new System.Drawing.Size(250, 268);
			this.panelContainer2.Size = new System.Drawing.Size(250, 283);
			...
			this.imageList.Images.SetKeyName(2, "2");
			this.imageList.Images.SetKeyName(3, "3");
			this.imageList.Images.SetKeyName(4, "4");
			this.imageList.Images.SetKeyName(5, "5");
			this.imageList.Images.SetKeyName(6, "6");
			this.imageList.Images.SetKeyName(7, "7");
			this.imageList.Images.SetKeyName(8, "8");
			this.imageList.Images.SetKeyName(9, "9");
			this.imageList.Images.SetKeyName(10, "10");
			this.imageList.Images.SetKeyName(11, "11");
			// 
			// ReportDesigner
			// 
			this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			this.Controls.Add(this.xrDesignPanel);
			...
			((System.ComponentModel.ISupportInitialize)(this.xrDesignDockManager)).EndInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.xrDesignBarManager)).EndInit();
		...
		private DevExpress.XtraReports.UserDesigner.XRDesignDockManager xrDesignDockManager;
		...
		private DevExpress.XtraReports.UserDesigner.XRDesignPanel xrDesignPanel;
		private DevExpress.XtraBars.BarDockControl barDockControlLeft;
		private DevExpress.XtraBars.BarDockControl barDockControlRight;
		private DevExpress.XtraBars.BarDockControl barDockControlBottom;
		private DevExpress.XtraBars.BarDockControl barDockControlTop;
		private DevExpress.XtraReports.UserDesigner.XRDesignBarManager xrDesignBarManager;
